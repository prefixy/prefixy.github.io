...
categories: software engineer developer prefix search autocomplete prefixy programming
image: https://prefixy.github.io/social.png
excerpt: This is the story of how we built Prefixy: a highly scalable, query optimized, hosted prefix search service for building autocomplete suggestions.
---
...
<form id="demo-form" class="" action="#">
  <input id="demo" type="search" placeholder="Start typing..." />
</form>
...
![completions with scores](/assets/completions-with-scores.png)
...
![why redis](/assets/why-redis.png)
...
![redis list](/assets/redis-list.png)
...
![redis sorted set](/assets/redis-sorted-set.png)
...
![out of memory](/assets/out-of-memory.png)
